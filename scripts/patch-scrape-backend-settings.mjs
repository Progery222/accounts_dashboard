...
function ScrapeBackendSettingsPanel(){
  ...
  return /*#__PURE__*/React.createElement('section',{style:{marginTop:28,padding:20,borderRadius:14,border:'1px solid rgba(255,255,255,0.08)',background:'rgba(0,0,0,0.25)'}},/*#__PURE__*/React.createElement('h2',{style:{margin:'0 0 6px',fontSize:18,fontWeight:700}},'Способ сбора данных'),/*#__PURE__*/React.createElement('p',{style:{margin:'0 0 16px',fontSize:13,color:'var(--ink-dim)',lineHeight:1.45}},'Изменения действуют только на новые запуски обновления. Аудитория всегда через Playwright.'),!apifyOk&&/*#__PURE__*/React.createElement('p',{style:{margin:'0 0 12px',fontSize:12,color:'#f59e0b'}},'Apify недоступен: задайте APIFY_ENABLED=1 и APIFY_TOKEN.'),cfg&&cfg.apify_active_jobs>0&&/*#__PURE__*/React.createElement('p',{style:{margin:'0 0 12px',fontSize:13,color:'var(--ink-dim)'}},'Активных задач Apify: ',cfg.apify_active_jobs),rows.map(([label,key])=>/*#__PURE__*/React.createElement('label',{key:key,style:{display:'flex',alignItems:'center',justifyContent:'space-between',gap:12,marginBottom:10,fontSize:14}},/*#__PURE__*/React.createElement('span',null,label),/*#__PURE__*/React.createElement('select',{value:draft[key],disabled:!apifyOk&&draft[key]==='apify',onChange:e=>setDraft(d=>({...d,[key]:e.target.value})),style:{minWidth:140,padding:'6px 10px',borderRadius:8,background:'rgba(255,255,255,0.06)',color:'inherit',border:'1px solid rgba(255,255,255,0.12)'}},/*#__PURE__*/React.createElement('option',{value:'playwright'},'Playwright'),/*#__PURE__*/React.createElement('option',{value:'apify',disabled:!apifyOk},'Apify'+(apifyOk?'':' (выкл.)')))),err&&/*#__PURE__*/React.createElement('p',{style:{color:'#f87171',fontSize:12,margin:'8px 0'}},err),/*#__PURE__*/React.createElement('button',{type:'button',disabled:saving,onClick:()=>void save(),style:{marginTop:8,padding:'8px 16px',borderRadius:8,border:'none',background:'#3b82f6',color:'#fff',fontWeight:600,cursor:saving?'wait':'pointer'}},saving?'Сохранение…':'Сохранить'));
}
`;
